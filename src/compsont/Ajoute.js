...
export default function Ajoute(props) {
  ...
  return (
    <div className='flex justify-center justify-items-center' style={{display:props.desplay?"":"none"}}>
      <div  className="block rounded-lg w-1/2 bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
        <h1 onClick={props.sup} className=" btn flex justify-end">X</h1>
        <h1 className="text-4xl text-center">create new contact</h1><br />
        <div className='flex mb-3'>
        <div   className='w-2/12  ml-5  text-lg'>Nom:</div><input ref={nom} type="text" className='form-control  ml-8 w-9/12 flex '/>
        </div>
        <div className='flex mb-3'>
       <div  className='w-2/12 ml-5  text-lg'>numéro de téléphone :</div> <input ref={tele} type="text" className='form-control  ml-8 w-9/12 flex '/>
        </div>
        <div className='flex mb-3 '>
         <div  className='w-2/12 ml-5  text-lg'>e-mail:</div><input type="text" ref={email} className='form-control  ml-8 w-9/12 flex '/>
        </div>
